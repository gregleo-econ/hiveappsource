...
axios
    .get(
        'http://127.0.0.1:9985/subject/get_history?my_email=' +
    ...
    .then((res) => {
        ...
        axios
            .get(
                'http://127.0.0.1:9985/subject/get_history_summary?my_email=' +
                store.state.user.email,
            )
            .then((res) => {
...
const info_experiment = function (item) {
    ...
    axios
        .get(
            'http://127.0.0.1:9985/subject/get_experiment_info?my_experiment_id=' +
            item.experiment_id,
        )
        .then((res) => {
