...
axios
    .get('http://econhive.com/api/researcher/get_experiment_list')
    .then(res => {
...
axios
    .get('http://econhive.com/api/researcher/get_researcher_list')
    .then(res => {
...
const getValues = function (variable) {
    axios
        .get('http://econhive.com/api/researcher/get_values', { params: { variable: variable } })
        .then(res => {
...
const submit_project = function () {
    ...
    if (errorList.value.length == 0) {
        ...
        axios
            .post('http://econhive.com/api/researcher/new_project', projectDataForSubmit)
            .then(res => {
...
const edit_project = async function () {
    ...
    if (errorList.value.length == 0) {
        ...
        axios
            .post('http://econhive.com/api/researcher/edit_experiment', studyData)
            .then(res => {
                emit('editSubmit')
